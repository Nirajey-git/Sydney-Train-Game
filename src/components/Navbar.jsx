...
const Navbar = () =>{
    ...
    <div className='relative hidden md:flex items-center justify-center '>
        ...
        >
            <li className='list-none w-full text-center p-4 hover:bg-text-400 transition-all cursor-pointer'><NavLink to="/home">Home</NavLink></li>
            <li className='list-none w-full text-center p-4 hover:bg-text-400 transition-all cursor-pointer'><NavLink to="/calculate">Calculate</NavLink></li>
            <li className='list-none w-full text-center p-4 hover:bg-text-400 transition-all cursor-pointer'><NavLink to="/aboutgame">About Game</NavLink></li>
        </div>
        </header>
